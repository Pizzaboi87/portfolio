  ...
  return (
    <div className="gallerydiv">
      <figure onClick={modalOpen}>
        <figcaption className={props.new ? "new" : null}>
          {props.title}
        </figcaption>
      ...
      <Modal open={isOpen}>
        ...
        <div className="details--pics">
          {props.youTube && <YouTube videoId={props.youTube} opts={opts} />}
        ...
        <div className="details--text">
          ...
          <div className="details--link">
            ...
            >
              ...
              <h4>{props.youTube ? "Download App" : "Visit Website"}</h4>
            </a>
          </div>
        </div>
        <button onClick={modalClose} className="modalbutton">
          Close
        </button>
      </Modal>
    </div>
